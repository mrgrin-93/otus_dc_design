...
Arista, например, видит BGP  и в оверлее и в андерлее ([rfc 7938](https://www.protokols.ru/WP/wp-content/uploads/2016/08/rfc7938.pdf), в котором arista соавтор).

А вот Cisco [считает](https://www.cisco.com/c/en/us/td/docs/dcn/whitepapers/cisco-vxlan-bgp-evpn-design-and-implementation-guide.html#CiscoNexus9000NXOSHardware):

> A famous **informational** RFC 7938
>
> A vital concluding point on this informational RFC 7938 is that it **does not** discuss or propose using eBGP as an underlay routing protocol in a VXLAN BGP EVPN fabric or any overlay running in the data center. Therefore, referencing this informational <mark style="color:green;">RFC 7938 is not a strong argument</mark> for using eBGP as an underlay in VXLAN BGP EVPN fabrics.
