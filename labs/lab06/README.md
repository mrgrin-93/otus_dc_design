...
router bgp 6510n
   vrf SEC1
      #вот тут возможно неправ, что сделал везде один rd
      rd 65010:999
...
### evpn
Появились маршруты типа 5
```
* >Ec    RD: 65010:999 ip-prefix 172.16.1.0/24
                                192.168.11.1          -       100     0       65010 65101 i
*  ec    RD: 65010:999 ip-prefix 172.16.1.0/24
                                192.168.11.1          -       100     0       65010 65101 i
* >      RD: 65010:999 ip-prefix 172.16.2.0/24
                                -                     -       -       0       i
*  Ec    RD: 65010:999 ip-prefix 172.16.2.0/24
                                192.168.11.2          -       100     0       65010 65102 i
*  ec    RD: 65010:999 ip-prefix 172.16.2.0/24
                                192.168.11.2          -       100     0       65010 65102 i
* >      RD: 65010:999 ip-prefix 172.16.255.0/31
                                -                     -       -       0       i
```
А также типа 2 с ip адресами
```
...
### host
Пинг с хоста l3 проходит до любого хоста в любом влан.
